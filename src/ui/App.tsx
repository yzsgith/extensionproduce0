...
import { VisualEditorConfiguration } from "./surfaces/VisualEditorConfiguration.js";
    ...
    <trpc.Provider client={trpcClient} queryClient={queryClient}>
      <QueryClientProvider client={queryClient}>
        <SurfaceRouter>
          ...
          <SurfaceRoute surface={Surfaces.VisualEditorConfiguration}>
            <VisualEditorConfiguration />
          </SurfaceRoute>
        </SurfaceRouter>
      </QueryClientProvider>
    </trpc.Provider>
